...
-- S'assurer que la lecture reste publique pour les visiteurs du site
-- (cette politique existe déjà mais on la vérifie)
CREATE POLICY IF NOT EXISTS "Public can view approved media" 
ON public.media 
FOR SELECT 
USING (true);